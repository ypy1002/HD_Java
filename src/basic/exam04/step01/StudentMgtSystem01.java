...
//		-	import 패키지명;
//		- import로 선언된 패키지의 클래스는 패키지명 없이 클래스 이름만으로 사용가능
//		-	import 패키지명.*;  ---> 패키지명만 선언해도 된다. 단, 자바 컴파일러가 해당 클래스를 찾는데 시간이 걸린다.
//		- 패키지명만 선언되어있으면 나중에 사용한 클래스가 어떤 패키징에 있는지 즉시 파악할 수 없다.
...
public class StudentMgtSystem01 {
	public static void main(String[] args) {
		...
		// import 해주면 아래와같이 사용가능하다.
		
		do {
			System.out.print("명령>");


			String input = scanner.nextLine(); // 키보드로부터 들어 온 값을 읽는다. 엔터를 만날 때까지
