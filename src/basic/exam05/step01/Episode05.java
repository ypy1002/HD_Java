...
class Student implements Serializable{
	...
	private static final long serialVersionUID = 137095731;
...
public class Episode05 {
	...
	public static void main01(String[] args) throws Exception {
		...
		//			=> 허용되지 않은 인스턴스를 출력하려 한다면 NotSerializableException 발생
		//		-	해결방법 : 클래스에 Serialize를 허용한다고 선언할것
		//		-	문법 : class 클래스명 implements Seralizable { .... }
